"""
agents/orchestrator/tools/task_planner.py — Structured task planning & dependency ordering
...
Usage:
    ...
    from agents.orchestrator.tools import TaskPlanner
...
class TaskPlanner:
    ...
    def _call_llm(self, prompt: str) -> list[dict]:
        ...
        try:
            import litellm
            from agents.orchestrator.config import DEFAULT_MODEL
